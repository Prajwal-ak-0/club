...
const Contact = () => {
    ...
    return (
        <>
            ...
            >
                <div className="absolute left-0 top-0 h-full w-full bg-cover opacity-70" style={{ backgroundImage: 'url(bg3.png)' }}>

                </div>
                <div className="relative w-3/4 z-10 text-white md:p-10 py-6 pt-28 pl- pr-4">
                    <div className="mt-12 flex items-center ml-6 justify-center md:gap-y-12 gap-y-12 md:mx-16 flex-col">
                        <Heading title="Activities & Events" />
                        <p className={`md:text-3xl text-2xl font-sans font-normal text-left md:leading-10 ${isHovered ? 'block' : 'hidden'}`}>
