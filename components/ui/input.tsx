  ...
  "",
  {
    variants: {
      variant: {
        ...
        secondary: "flex h-[40px]  md:h-[44px] text-white  w-full rounded-lg bg-black px-3 py-2 text-sm  md:text-md font-light bg-black placeholder:text-neutral-500 placeholder:text-sm disabled:cursor-not-allowed disabled:opacity-50",
        tertiary: "flex h-[40px]  md:h-[44px] text-white  md:w-32 w-24 rounded-md bg-black px-3 py-2 text-sm  md:text-md font-light placeholder:text-neutral-500 placeholder:text-sm disabled:cursor-not-allowed disabled:opacity-50",
        textArea: "flex h-[80px]  md:h-[80px] text-white  w-full rounded-lg bg-black px-3 py-2 text-sm md:text-md font-light placeholder:text-neutral-500 placeholder:text-sm disabled:cursor-not-allowed disabled:opacity-50",
      },
    },
    defaultVariants: {
      variant: "default",
